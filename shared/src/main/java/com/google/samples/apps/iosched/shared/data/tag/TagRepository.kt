...
{
    fun getTags(): List<Tag> = conferenceDataRepository.getConferenceData().tags

    fun getTagsOffline(): List<Tag> = conferenceDataRepository.getOfflineConferenceData().tags
}
