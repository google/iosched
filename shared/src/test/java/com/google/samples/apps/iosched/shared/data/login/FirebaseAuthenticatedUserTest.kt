...
/**
 * Tests for [FirebaseAuthenticatedUser].
 */
class FirebaseAuthenticatedUserTest {
    ...
    @Test
    fun loggedInUser() {
        val subject = FirebaseAuthenticatedUser(mockedNonAnonymousFirebaseAuth)
    ...
    @Test
    fun anonymousUser() {
        val subject = FirebaseAuthenticatedUser(mockedAnonymousFirebaseAuth)
    ...
    fun errorGettingIdToken() {
        val subject = FirebaseAuthenticatedUser(mockedNonAnonymousUnsuccessfulFirebaseAuth)
