...
public enum ScheduleUriEnum {
    ...
    SESSIONS_ROOM_AFTER(511, "sessions/room/*/after/*", ScheduleContract.Sessions.CONTENT_TYPE_ID, false, null),
    SESSIONS_UNSCHEDULED(512, "sessions/unscheduled/*", ScheduleContract.Sessions.CONTENT_TYPE_ID, false, null),
    SESSIONS_COUNTER(513, "sessions/counter", null, true, null),
    SESSIONS_AFTER(514, "sessions/after/*", ScheduleContract.Sessions.CONTENT_TYPE_ID, false, null),
