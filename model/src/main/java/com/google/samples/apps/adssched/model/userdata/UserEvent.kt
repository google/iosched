...
package com.google.samples.apps.adssched.model.userdata

import com.google.samples.apps.adssched.model.SessionId
import com.google.samples.apps.adssched.model.reservations.ReservationRequest
import com.google.samples.apps.adssched.model.reservations.ReservationRequest.ReservationRequestEntityAction.CANCEL_REQUESTED
import com.google.samples.apps.adssched.model.reservations.ReservationRequest.ReservationRequestEntityAction.RESERVE_REQUESTED
import com.google.samples.apps.adssched.model.reservations.ReservationRequestResult
import com.google.samples.apps.adssched.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_DENIED_CUTOFF
import com.google.samples.apps.adssched.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_DENIED_UNKNOWN
import com.google.samples.apps.adssched.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_SUCCEEDED
import com.google.samples.apps.adssched.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_CLASH
...
import com.google.samples.apps.adssched.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_CLASH
import com.google.samples.apps.adssched.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_CUTOFF
import com.google.samples.apps.adssched.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_UNKNOWN
import com.google.samples.apps.adssched.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_SUCCEEDED
import com.google.samples.apps.adssched.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_WAITLISTED
